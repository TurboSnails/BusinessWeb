  ...
  const timelineData = [
    {
      ...
      isTable: true,
      actions: [
        { id: 'jan9-alert', text: '🎯 **核心结论：劳动力市场降温但稳定，软着陆确认 → 市场反应积极**', isAlert: true },
        { id: 'jan9-header-1', text: '## 📊 关键数据一览', isHeader: true },
        { id: 'jan9-table-1', text: '**新增非农**|5万|16.8万|⚠️ 显著低于预期', isTableRow: true },
        { id: 'jan9-table-2', text: '**失业率**|4.4%|4.5%|✅ 好于预期', isTableRow: true },
        { id: 'jan9-table-3', text: '**平均时薪**|$37.02|+3.8%同比|⚠️ 通胀顽固信号', isTableRow: true },
        { id: 'jan9-table-4', text: '**前值修正**|11月5.6万|10月-17.3万|⚠️ 两月下修7.6万', isTableRow: true },
        { id: 'jan9-divider-1', text: '---', isHeader: true },
        { id: 'jan9-header-2', text: '## 🔍 深度解读', isHeader: true },
        { id: 'jan9-1', text: '📉 **就业趋势**：月均增长降至4.9万，全年仅58.4万（2003年来最低），科技巨头AI驱动裁员超18万岗位' },
        { id: 'jan9-2', text: '🔄 **结构转移**：科技→服务/医疗业，参与率下滑掩盖失业压力，无衰退迹象' },
        { id: 'jan9-3', text: '🏦 **Fed政策**：时薪+3.8%强化高利率维持，1月降息概率<5%，市场解读为"软着陆"' },
        { id: 'jan9-4', text: '📈 **市场反应**：美股创纪录（道指+0.48%、标普+0.65%、纳指+0.81%），AI生产力叙事推动科技股' }
      ],
      notes: '招聘疲软而非裁员潮，支持Fed观望而非紧急行动。投资者消退衰退担忧，转向韧性叙事和板块轮动。'
    },
    {
      date: '2026年1月11日',
      day: '周四',
      ...
      isTable: true,
      actions: [
        { id: 'jan11-alert', text: '🎯 **核心结论：软着陆确认，通胀仍顽固 → 维持中性偏防御（75-80%仓位）**', isAlert: true },
        ...
        { id: 'jan11-header-2', text: '## 🏦 Fed政策路径', isHeader: true },
        { id: 'jan11-fed-1', text: '📅 **降息时间**：可能延后至Q2（6月），1月暂停几乎确定' },
        ...
        { id: 'jan11-header-3', text: '## ⚠️ 阈值触发', isHeader: true },
        { id: 'jan11-thresh-1', text: '- [x] **时薪 3.8%** → ⚠️ 临界，警惕工资-物价螺旋' },
        { id: 'jan11-thresh-2', text: '- [x] **非农 5万** → ✅ 触发，劳动力市场降温' },
        { id: 'jan11-thresh-3', text: '- [ ] **CPI环比 > 0.4%** → 未触发' },
        { id: 'jan11-divider-3', text: '---', isHeader: true },
        { id: 'jan11-header-4', text: '## 💡 操作建议', isHeader: true },
        { id: 'jan11-op-1', text: '```\n当前配置：75-80% 风险资产\n\n🔴 减仓至70%：1月CPI环比>0.3% 且 时薪>4%\n🟢 加仓至85%：1月CPI环比<0.2% 且 非农反弹>10万\n🟡 增持现金30%：VIX>20 + SPY单日跌>1%\n```' }
      ],
      notes: '重点观察：1月PCE数据（Fed首选指标）、2月非农、Fed 1月会议纪要'
    },
    {
      date: '2026年1月12-16日',
      day: '周一至周五',
