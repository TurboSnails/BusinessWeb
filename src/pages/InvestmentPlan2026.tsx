...
const InvestmentPlan2026 = () => {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      completed: true,
      actions: [
        { id: 'jan23-alert', text: '🎯 **综合评估：市场流动性充裕，银行拨备谨慎但可控，信用质量整体稳定 → 维持Stage 1防守配置**', isAlert: true },
        { id: 'jan23-1', text: '📊 **VIX (恐慌指数)**：最新15.73（1/22），1/21收盘20.09 → 处于低至中等水平，市场恐慌情绪整体温和，未触发>20阈值' },
        { id: 'jan23-2', text: '💰 **HY OAS (高收益债利差)**：2.73%（极窄），处于历史低位 → 市场风险溢价被极度压缩，资金环境宽松' },
        { id: 'jan23-3', text: '📈 **IG OAS (投资级债利差)**：约0.76%，处于历史低位 → 企业融资成本相对国债溢价极小' },
        { id: 'jan23-4', text: '🏦 **XLF vs SPY**：XLF YTD -0.95%，最新$54.44 → 金融板块表现相对大盘略显疲弱，需关注' },
        { id: 'jan23-5', text: '🔴 **JPM拨备**：$46.6亿（Q4），同比+77%，净冲销$25.1亿（+5%）→ ⚠️包含~$22亿Apple Card储备，2026信用卡冲销率指引3.4%' },
        { id: 'jan23-6', text: '🟢 **BAC拨备**：$13.1亿（Q4），低于预期$1.9亿，净冲销$13亿（环比-$1亿，同比-$2亿）→ 信用质量稳定' },
        { id: 'jan23-7', text: '🟢 **WFC拨备**：$10.4亿（Q4），净冲销-13% → 虽净冲销下降，但银行增加储备应对潜在放缓' },
        { id: 'jan23-8', text: '🟡 **C拨备**：$22.2亿（Q4），零售服务净信用损失率5.73%，总储备>$210亿 → 主要来自美国信用卡净损失' },
        { id: 'jan23-9', text: '💳 **信用卡违约**：行业层面Q3冲销率3.92%（环比↓），逾期率2.98%（稳定↓）→ 四大行Q4整体稳定或改善，无显著恶化' },
        { id: 'jan23-10', text: '🏢 **CRE违约（商业地产）**：Q4未见大幅上升，四大行CRE暴露整体可控，无重大违约爆发信号' },
        { id: 'jan23-11', text: '📋 **SLOOS消费贷**（10月调查）：信用卡标准基本不变，汽车贷款标准有所放松 → 整体消费贷标准未显著收紧' },
        { id: 'jan23-12', text: '📋 **SLOOS商业贷**（10月调查）：部分银行C&I贷款标准收紧，商业地产标准和需求大多不变 → 商业贷款仍有谨慎收紧迹象' },
        { id: 'jan23-13', text: '⚠️ **关键信号**：除JPM因Apple Card特殊交易大幅增加拨备外，其他银行保持温和或下降；金融板块XLF短期弱势反映监管和政策不确定性' },
        { id: 'jan23-14', text: '💡 **操作建议**：维持Stage 1防守配置（总仓位70-75%），密切关注下一期SLOOS（2026年2月初发布），若HY OAS升至>300bps或XLF连续跑输≥4周则考虑升级防御' }
      ],
