          ...
          <tbody>
            {[
              ...
              { 
                ...
                icon: '💊',
                share: 2, 
                logic: '全球糖尿病和肥胖症治疗领域的领导者，GLP-1药物（如Wegovy、Ozempic）市场地位领先。受益于全球肥胖和糖尿病患病率上升，需求持续增长。公司研发实力强，产品管线丰富，现金流充沛，是防御性配置的优质选择。'
              },
              { 
                symbol: 'AMZN',
                name: 'AMZN',
              ...
              { 
                ...
                icon: '🛡️',
                share: 1, 
                logic: '美国领先的政府咨询和技术服务公司，主要服务于国防、情报和民用政府机构。业务模式稳定，合同周期长，现金流可预测。受益于政府数字化转型和网络安全需求增长，长期增长确定性高，适合防御性配置。'
              },
              { 
                symbol: 'BYD',
                name: 'BYD',
